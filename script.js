...
function skipForward() {
    ...
    pTag.innerText = "--⏩ 5s-->";
    setTimeout(function () {
        pTag.innerText = "Performed by: Anirudh Ravichander";
    }, 500);
}
...
function showCredits() {
    alert("Song: Naa Ready (From Leo)\nPerformed by: Anirudh Ravichander ,Asal Kolaar, Thalapathy Vijay\nWritten by: Anirudh RavichanderAsal ,Kolaar, Vishnu Edavan,\nSource: Sony Music Entertainment India Pvt. Ltd");
}
